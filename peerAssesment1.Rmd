...
```{r}
library(ggplot2)
qplot(stepsPerDay2$steps, geom="histogram") 
```
...
The original mean number of steps taken each day is `r averageStepsPerDay2`.
The orginal median number of steps taken each day is `r medianStepsPerDay2`
